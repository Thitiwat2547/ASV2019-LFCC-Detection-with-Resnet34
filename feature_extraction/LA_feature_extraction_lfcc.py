...
# ------------------ Configuration ------------------
# Hard-code root directory of ASVspoof2019 LA data
ROOT = r"D:\NECTEC\automatic speaker verification\LA\LA"
...
def process_file(task):
    ...
    folder = os.path.join(ROOT, f"ASVspoof2019_LA_{subset}", "flac")
...
def main():
    for subset in ("train", "dev", "eval"):
        ...
        proto_fn = "ASVspoof2019.LA.cm.train.trn.txt" if subset == "train" else f"ASVspoof2019.LA.cm.{subset}.trl.txt"
        ...
        hdf5storage.savemat(f"LFCC_LA_bonafide_{subset}.mat", {"genuineFeatureCell": bona}, format="7.3")
        hdf5storage.savemat(f"LFCC_LA_spoof_{subset}.mat",    {"spoofFeatureCell": spoof}, format="7.3")
